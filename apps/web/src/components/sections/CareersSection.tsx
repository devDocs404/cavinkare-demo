	...
	return (
		...
		>
			...
			<div className="mb-32 flex flex-col pl-4 md:pl-8 lg:flex-row lg:items-center lg:pl-12 xl:pl-[calc(50vw-640px+2rem)]">
				{/* Left Text Block */}
				<FadeInStaggerContainer className="w-full shrink-0 pr-4 md:pr-8 lg:w-[480px] lg:pr-12 xl:w-[500px]">
					<FadeInStaggerItem className="max-w-5xl">
						<h2
							id="careers-heading"
							className="text-3xl leading-[0.95] font-bold tracking-[-0.05em] text-brand-dark sm:text-5xl md:text-5xl lg:text-6xl xl:text-6xl dark:text-white"
						>
					...
					<FadeInStaggerItem>
						<p className="mb-8 mt-6 text-base leading-relaxed text-gray-600 md:text-lg dark:text-gray-400">
							Discover a culture where innovation is encouraged, ideas are
							heard, and careers are built for impact. From R&D labs to creative
				...
				<FadeIn delay={0.4} className="min-w-0 flex-1">
					<JobCarousel />
				</FadeIn>
			</div>
