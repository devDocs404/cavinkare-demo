  ...
  if (item.isOverlap) {
    return (
      <div className={`relative z-10 ${item.containerClass}`}>
        <div className="absolute top-0 right-0 bottom-0 left-0 -z-10 rounded-tl-[2rem] bg-surface-section md:-top-6 md:-left-6 md:rounded-tl-[3rem] dark:bg-slate-900" />
      ...
      <section className="relative w-full bg-surface-section px-6 py-24 md:px-12 dark:bg-slate-900">
        <div className="relative z-10 mx-auto max-w-7xl">
          ...
          <div className="mx-auto mb-12 max-w-4xl text-center md:mb-16">
            ...
            <p className="mx-auto mt-6 max-w-full px-4 text-center text-sm leading-relaxed font-semibold text-gray-500 md:mt-10 md:text-base lg:text-lg">
          ...
          {/* GRID */}
          <div className="grid w-full grid-cols-1 gap-4 md:grid-cols-12 md:gap-6">
            {NEWS_ITEMS.map((item) => (
